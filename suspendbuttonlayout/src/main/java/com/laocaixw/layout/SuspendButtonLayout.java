...
public class SuspendButtonLayout extends RelativeLayout implements View.OnTouchListener {
    ...
    public interface OnSuspendListener {
         ...
         *
         * @param status 按钮状态
         *               <br/>已经关闭：SuspendButtonLayout.SUSPEND_BUTTON_CLOSED
         *               <br/>已经打开：SuspendButtonLayout.SUSPEND_BUTTON_OPENED
         *               <br/>正在关闭：SuspendButtonLayout.SUSPEND_BUTTON_CLOSING
         *               <br/>正在打开：SuspendButtonLayout.SUSPEND_BUTTON_OPENING
         *               <br/>正在移动：SuspendButtonLayout.SUSPEND_BUTTON_MOVING
         *               <br/>移动到位：SuspendButtonLayout.SUSPEND_BUTTON_MOVED
         */
